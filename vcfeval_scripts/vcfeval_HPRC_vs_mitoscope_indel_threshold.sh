...
tech="ont"
tool="mitoscope"
categories="_indel1 _indel5 _indel10"
...
for category in ${categories[@]}; do
    ...
    RTG_OUTDIR="/net/nwgc/vol1/home/czaka/analysis/mitoscope/smaht/hapmap/hprc_truthset_eval/mitoscope_indel_bench/${tool}${category}/${tech}/"
