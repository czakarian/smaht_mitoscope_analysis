...
INDIR="/net/nwgc/vol1/home/czaka/analysis/${tool}/smaht/hapmap_downsampled/${tech}/"
SAMPLES=$(cut -d',' -f 1 ${INDIR}/samples.csv)

MULTISAMPLE_VCF="${INDIR}/output/merged.mt.baldur.annotated.vcf.gz"
MULTISAMPLE_FORMATTED_VCF="${INDIR}/output/merged.mt.baldur.annotated.vcfeval.vcf.gz"
...
RTG_OUTDIR="/net/nwgc/vol1/home/czaka/analysis/mitoscope/smaht/hapmap/hprc_truthset_eval/mitoscope_coverage_bench/${tool}/${tech}/"
...
do
    echo ${SAMPLE}
    INPUT_VCF="${INDIR}/output/${SAMPLE}/variants/baldur/${SAMPLE}.mt.baldur.annotated.vcf.gz"
    FORMATTED_VCF="${INDIR}/output/${SAMPLE}/variants/baldur/${SAMPLE}.mt.baldur.annotated.vcfeval.vcf.gz"
