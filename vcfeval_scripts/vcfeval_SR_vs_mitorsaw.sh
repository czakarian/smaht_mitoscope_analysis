...
tech="pacbio"
tool="mitorsaw"
SAMPLES=$(cut -d',' -f 1 /net/nwgc/vol1/nobackup/czaka/${tool}/smaht/${tech}/samples.csv | tail +2)
...
MULTISAMPLE_VCF="/net/nwgc/vol1/nobackup/czaka/${tool}/smaht/${tech}/output/merged.${tool}.vcf.gz"
MULTISAMPLE_FORMATTED_VCF="/net/nwgc/vol1/nobackup/czaka/${tool}/smaht/${tech}/output/merged.${tool}.vcfeval.vcf.gz"
MULTISAMPLE_FORMATTED_VCF_HIGHCONF="/net/nwgc/vol1/nobackup/czaka/${tool}/smaht/${tech}/output/merged.${tool}.vcfeval.highconf.vcf.gz"
...
do
    echo ${SAMPLE}
    INPUT_VCF="/net/nwgc/vol1/nobackup/czaka/${tool}/smaht/${tech}/output/${SAMPLE}/${SAMPLE}.mitorsaw.vcf.gz"
    FORMATTED_VCF="/net/nwgc/vol1/nobackup/czaka/${tool}/smaht/${tech}/output/${SAMPLE}/${SAMPLE}.mitorsaw.vcfeval.vcf.gz"
