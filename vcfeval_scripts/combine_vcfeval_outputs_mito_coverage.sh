...
INDIR="/net/nwgc/vol1/home/czaka/analysis/mitoscope/smaht/hapmap/hprc_truthset_eval/mitoscope_coverage_bench"
TABLE_BY_SAMPLE="/net/nwgc/vol1/home/czaka/analysis/mitoscope/smaht/benchmark_analysis/vcfeval_scripts/vcfeval_table_mitoscope_coverage.csv"

ALL_OUT_BY_SAMPLE="${INDIR}/HPRC.vcfeval.by_sample.all.tsv"
SNV_OUT_BY_SAMPLE="${INDIR}/HPRC.vcfeval.by_sample.snvs.tsv"
INDEL_OUT_BY_SAMPLE="${INDIR}/HPRC.vcfeval.by_sample.indels.tsv"
