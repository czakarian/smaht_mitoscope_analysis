...
TABLE_BY_SAMPLE="/net/nwgc/vol1/home/czaka/analysis/mitoscope/smaht/benchmark_analysis/vcfeval_scripts/vcfeval_table_mitoscope_indels.csv"

## tables by sample
INDEL_OUT_BY_SAMPLE="${INDIR}/mitoscope_vaf_comparison/HPRC.vcfeval.by_sample.indels.tsv"
...
do
    ...
    ## indels
    x=$(zcat ${INDIR}/mitoscope_indel_bench/${tool}_${category}/${tech}/${sample}/non_snp_roc.tsv.gz | grep -v '^#' | cut -f 2- || true)
    echo -e "${tool}\t${category}\t${tech}\t${sample}\t${x}" >> ${INDEL_OUT_BY_SAMPLE}
