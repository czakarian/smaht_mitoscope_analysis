...
LIST_OF_VCFS=$(ls /net/nwgc/vol1/nobackup/czaka/mitoscope/smaht/hapmap/${tech}/output/*/variants/baldur/*.baldur.norm.vcf.gz)
bcftools merge -m none ${LIST_OF_VCFS} -Oz -o ${BALDUR_VCF}
