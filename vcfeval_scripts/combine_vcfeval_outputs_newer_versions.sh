...
## tables by sample
ALL_OUT_BY_SAMPLE="${INDIR}/combined_tables/HPRC.vcfeval.by_sample.all.v2.tsv"
SNV_OUT_BY_SAMPLE="${INDIR}/combined_tables/HPRC.vcfeval.by_sample.snvs.v2.tsv"
INDEL_OUT_BY_SAMPLE="${INDIR}/combined_tables/HPRC.vcfeval.by_sample.indels.v2.tsv"
