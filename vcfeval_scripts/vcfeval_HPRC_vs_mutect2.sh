...
tech="illumina"
tool="mutect2"
SAMPLES=$(cut -d',' -f 1 /net/nwgc/vol1/home/czaka/analysis/mutect2/smaht/illumina/hapmap/samples.csv | tail +2)
...
rtg vcfeval \
    ...
    -t ${REF_RTG} \
    -o ${RTG_OUTDIR}/vcfeval_result_all

rtg vcfeval \
    -b ${HPRC_FORMATTED_VCF}  \
    -c ${MULTISAMPLE_FORMATTED_VCF_HIGHCONF} \
    -t ${REF_RTG} \
    -o ${RTG_OUTDIR}/vcfeval_result_highconf
...
do
    ...
    rtg vcfeval \
        ...
        -c ${FORMATTED_VCF} \
        -t ${REF_RTG} \
        -o ${RTG_OUTDIR}/individual_samples/${SAMPLE}
