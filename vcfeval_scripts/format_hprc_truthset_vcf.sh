...
bcftools view -i 'INFO/AC>0' /net/nwgc/vol1/home/czaka/analysis/mitoscope/smaht/hapmap/hprc_truthset_eval/hprc-v2.0-mc-grch38.wave.check.withnames.vcf | \
bcftools view -s HG002 | bcftools annotate -x FORMAT | \
bcftools +setGT -- -t a -n c:'1' | \
sed 's/chrM/MT/g' | sed 's/HG002/SAMPLE/g' > /net/nwgc/vol1/home/czaka/analysis/mitoscope/smaht/hapmap/hprc_truthset_eval/hprc-v2.0-mc-grch38.wave.check.withnames.filt.vcf